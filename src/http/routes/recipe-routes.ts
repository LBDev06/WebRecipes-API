...
import { favoriteRecipesByUser } from "../controllers/recipe/favorite-recipes-by-user";
...
export function recipeRoutes(app: FastifyInstance){
   ...
   app.get('/recipes/favorite-recipes-by-user', {onRequest: [verifyJwt, loginRequired]}, favoriteRecipesByUser)
}